...
--
-- Name: elements uniquesymbolname; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniquesymbolname UNIQUE (symbol, name);


--
-- Name: properties atomicnumberforeign; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomicnumberforeign FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties typeidforeign; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT typeidforeign FOREIGN KEY (type_id) REFERENCES public.types(type_id);
